...
readonly HUMANREF="/home/ubuntu/genomes/GCA_000001405.15_GRCh38_full_analysis_set.fna.hisat2_index"
...
fastq2bam() {
    ...
    hisat2 --time --threads "$THREADS" --mm -x "$REF" -1 "$r1" -2 "$r2" 2>> "${id}.log" \
